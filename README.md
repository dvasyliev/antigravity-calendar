...
This repository contains the Source Code for the "Calendar App" from 🧑🏻‍💻 [Google Antigravity for Beginners: AI Coding Crash Course ](https://linkly.link/2ZqIu) course.
...
1. Open repository main [page](https://github.com/dvasyliev/antigravity-calendar).
...
1. Open [commits](https://github.com/dvasyliev/antigravity-calendar/commits/main/) page.
